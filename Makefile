...
SRC_BONUS =	./bonus/ft_lstadd_back_bonus.c ./bonus/ft_lstadd_front_bonus.c ./bonus/ft_lstclear_bonus.c ./bonus/ft_lstdelone_bonus.c \
			./bonus/ft_lstiter_bonus.c ./bonus/ft_lstlast_bonus.c ./bonus/ft_lstmap_bonus.c ./bonus/ft_lstnew_bonus.c ./bonus/ft_lstsize_bonus.c
OBJ = $(SRC:.c=.o)
